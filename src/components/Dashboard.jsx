...
//     <Button 
//       className="bg-yellow-400 hover:bg-yellow-500 text-purple-900 font-bold py- rounded-xl shadow-md text-xs flex items-center justify-center gap-1 w-full"
...
//     {showLeaderboard && (
//       <div className="absolute top-full mt-1 w-120 bg-white rounded-xl shadow-lg z-10">
//         <div className="p-4">
...
//     <Button 
//       className="bg-pink-300 hover:bg-pink-400 text-purple-900 font-bold py-1 rounded-xl shadow-md text-xs w-full flex items-center justify-center gap-1"
...
//     {showProgress && (
//       <div className="absolute top-full mt-1 w-full bg-white/95 backdrop-blur-sm rounded-lg shadow-lg z-10 border border-pink-100">
